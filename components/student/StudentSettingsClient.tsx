  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-lg mx-auto">
        ...
        <p className="text-muted-foreground mb-8">{t("student.settings.subtitle")}</p>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">{t("student.link.title")}</CardTitle>
            </CardHeader>
            <CardContent>
              <Link href="/student/link">
                <Button variant="outline" className="w-full">
                  {t("student.link.claimAccount")}
                </Button>
              </Link>
            </CardContent>
          </Card>
