# ClassSync Documentation

## Overview

This folder contains all documentation for the ClassSync project.

## Files

- **[PRD.md](./PRD.md)** — Product Requirements Document
  - User personas and workflows
  - Core features across 9 phases
  - Success metrics and constraints
  - Data model overview

- **[../CLAUDE.md](../CLAUDE.md)** — Engineering Guidelines
  - Tech stack (Next.js, TypeScript, Prisma, etc.)
